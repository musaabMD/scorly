...
//   return (
//     <div className="w-full max-w-7xl mx-auto p-8 bg-white rounded-lg shadow">
//       {/* Stats Bar */}
...
//             className="h-12 px-4 bg-gray-50 border border-gray-200 rounded-lg appearance-none cursor-pointer pr-10 text-lg"
//           >
//             {categories.map((cat) => (
...
//             className="w-full h-12 pl-12 pr-4 bg-gray-50 border border-gray-200 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
//           />
...
//           className="flex items-center gap-1.5 px-4 h-12 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors ml-auto text-lg font-medium"
//         >
...
//               className={`flex items-center gap-3 px-5 h-12 rounded-lg transition-colors text-lg ${
...
// // export default TestPrepFilter;
// // // app/[locale]/exams/[category]/[examId]/page.js
// // "use client"

// // import { useEffect } from 'react';
// // import { useParams } from 'next/navigation';
// // import TestPrepFilter from '@/components/TestPrepFilter';

// // export default function ExamPage() {
// //     const params = useParams();
  
// //     useEffect(() => {
// //       // Here you could fetch exam data based on params.examId and params.category
// //       console.log('Exam category:', params.category);
...
const ExamPage = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-8 bg- ">
    
      {/* Page Header */}
      <div className="text-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">
          {currentFilterLabel} Questions 
          <span className="ml-2 text-lg text-gray-500">({currentQuestions.length})</span>
        </h1>
      </div>
  ...
  <FilterBar
      ...
      <FilterTabs
        ...
        counts={Object.keys(filteredData).reduce((acc, key) => {
          acc[key] = filteredData[key]?.length || 0;
          return acc;
        }, {})}
      />
  ...
  <StatsBar stats={stats} />
      ...
      {currentQuestions.length > 0 ? (
        <QuestionDisplay type={activeFilter} data={filteredData} showAnswers={showAnswers} />
      ) : (
